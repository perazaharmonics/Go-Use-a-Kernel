...
var (
	logdirname                       = ""
	logpathname string               = ""
	errpathname string               = "/home/perazaharmonics/Projects/NetGo/logs/error.txt"
...
func NewLogger() (*Logger, error) { // ------------ NewLogger ----------- //
	l := &Logger{ // Our new logger instance.
		...
		key:    0x7003,       // Set the semaphore key
...
func (l *Logger) Initialize() error { // ----------- Initialize ----------- //
	...
	sem, semerr = semaphore.NewSemaphore(appname, "log", "perazaharmonics", l.key) // Make a semaphore.
...
// ------------------------------------ //
func (l *Logger) GetSemKey() int { // ---------- GetSemKey ----------- //
	return sem.GetKey() // Return the semaphore key.
} // ---------- GetSemKey ----------- //
func (l *Logger) GetSemId() int { // ---------- GetSemId ------------ //
	return sem.GetID() // Return the semaphore id.
} // ---------- GetSemId ------------ //
